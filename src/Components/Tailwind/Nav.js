...
export default function Nav({setSearch,setUrl,search,showmaps}) {
    return (
        <div>
            ...
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="flex space-x-4">
                        ...
                        {showmaps ?
                            <button class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium" onClick={() => {
                                        setSearch(!search);
                                        }}>Map-search
                            </button>
                            : ""
